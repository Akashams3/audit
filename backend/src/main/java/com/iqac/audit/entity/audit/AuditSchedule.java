...
public class AuditSchedule {
    ...
    private String academicType; // e.g. "Assigned Individual"
    ...
    public AuditSchedule(Long id, String title, LocalDate auditDate, LocalDate dueDate, LocalTime dueTime, String description, String status, String departmentCode, String auditType, String academicPhase, String year, String semester, String academicType, LocalDateTime createdAt) {
        this.id = id;
        this.title = title;
