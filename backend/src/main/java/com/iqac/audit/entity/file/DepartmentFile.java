...
public class DepartmentFile {
    ...
    private String documentType; // e.g. Faculty List, Infrastructure, Reports, etc.
    ...
    public DepartmentFile(Long id, String fileName, String storedFileName, String filePath, String fileUrl, Long fileSize, String fileType, String department, Faculty faculty, String uploadedBy, LocalDateTime uploadedDate, String status, String documentType, AuditStage stage, String year, String semester, Boolean isLate, LocalDateTime actualSubmissionTime) {
        this.id = id;
