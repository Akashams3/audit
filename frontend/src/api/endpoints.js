...
// Department
export const getDepartments = (params) => api.get("/iqac/department", { params });
...
// Faculty
export const getFaculties = (params) => api.get("/iqac/faculty", { params });
...
// HOD
export const getHods = (params) => api.get("/iqac/hod", { params });
