                            ...
                            {uploaded ? (
                              <>
                                 {uploaded.fileName.toLowerCase().endsWith('.pdf') && (
                                   <a href={`${API_BASE_URL}/api/files/view/academic/${uploaded.id}?token=${localStorage.getItem('token')}`}
                                 ...
                                 <a href={`${API_BASE_URL}/api/files/download/academic/${uploaded.id}?token=${localStorage.getItem('token')}`}
                        ...
                        <div key={req.id} className={`flex items-center justify-between p-3.5 rounded-xl border transition-colors ${
                          ...
                          <div className="flex items-center space-x-2 flex-shrink-0 ml-3">
                            ...
                            {uploaded ? (
                              <>
                                 {uploaded.fileName.toLowerCase().endsWith('.pdf') && (
                                   <a href={`${API_BASE_URL}/api/files/view/department/${uploaded.id}?token=${localStorage.getItem('token')}`}
                                     target="_blank" rel="noopener noreferrer"
                                     className="p-1.5 text-slate-400 hover:text-emerald-600 hover:bg-white rounded-lg border border-slate-200/50 transition-colors">
                                     <Eye size={13} />
                                   </a>
                                 )}
                                 <a href={`${API_BASE_URL}/api/files/download/department/${uploaded.id}?token=${localStorage.getItem('token')}`}
                                   className="p-1.5 text-slate-400 hover:text-[#0A3D91] hover:bg-white rounded-lg border border-slate-200/50 transition-colors">
                                   <Download size={13} />
                                 </a>
